    ...
    <section className="mt-12 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link to="/Signup">
            <button className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-primary text-background text-sm font-medium shadow-l cursor-pointer active:scale-[0.995] hover:shadow-s ring-1 ring-primary/90">
              Create your first poll
              <IconArrowRight size={15} />
            </button>
          </Link>
          <a href="#how">
            <button className="p-0.5 rounded-xl bg-linear-to-b from-white to-stone-200/40 shadow-m active:shadow-[0_0px_1px_rgba(0,0,0,0.5)] active:scale-[0.995] cursor-pointer">
