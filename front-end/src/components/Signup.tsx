            ...
            <div className="w-full h-full p-5 rounded-xl shadow-m shadow-black/10 ring-1 ring-black/10  bg-card">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2 flex flex-col">
                        ...
                        <input value={name} onChange={(e) => setName(e.target.value)} type="text" required placeholder="John Doe" className="border py-2 px-4 rounded-xl shadow-s outline-none placeholder:text-neutral-600 focus:ring-1 focus:ring-neutral-400" />
                    </div>
                    <div className="space-y-2 flex flex-col">
